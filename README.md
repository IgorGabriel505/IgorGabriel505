...
Tenho interesse em construir minha carreira como **Desenvolvedor Back-end Java**, aprofundando meus conhecimentos em desenvolvimento de sistemas, APIs, banco de dados e arquitetura de software.
...
`Arduino` · `ESP32` · `Sensores` · `Automação`
